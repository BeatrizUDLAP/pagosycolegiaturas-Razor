...
$(document).ready(function () {
    ...
    var swiperFull = new Swiper('.swiper-full-screen-pay', {
        loop: true,
        slidesPerView: 1,
        preventClicks: false,
        allowTouchMove: true,
    ...
    var swiperThreeSlides = new Swiper('.swiper-three-slides-cnu', {
        allowTouchMove: true,
        slidesPerView: 3,
        preventClicks: false,
        pagination: {
    ...
    var swiperFourSlides = new Swiper('.swiper-four-slides-eve', {
        allowTouchMove: true,
        slidesPerView: 4,
        preventClicks: false,
        pagination: {
